...
def inputToSQL(category, name = ''):
    ...
    if category == 'get_all':
        ...
        for d in dataRecieved:
            ...
            # print(d[7])
            res[d[1]]['moistureValue'].append(d[7])
            res[d[1]]['sunExposure'].append(d[8])
    ...
    if category == 'get_specific':
        ...
        res = {
            ...
            'moistureValue': average([indiv[7] for indiv in dataRecieved]),
            'sunExposure': average([indiv[8] for indiv in dataRecieved]),
        }
...
print(inputToSQL('get_all'))
print(inputToSQL('water', 'Jerry'))
print(inputToSQL('get_specific', 'Jerry'))
